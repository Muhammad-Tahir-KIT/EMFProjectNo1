 ...
 * </p>
 * <ul>
 *   <li>{@link conference.impl.SpeakerImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SpeakerImpl extends MinimalEObjectImpl.Container implements Speaker {
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConferencePackage.SPEAKER__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ConferencePackage.SPEAKER__NAME:
				return getName();
		}
